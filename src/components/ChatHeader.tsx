  ...
  return (
    <div className="chat-header">
      <div className="chat-header__topbar">
        {/* "Hamburger" icon (could be an SVG or a FontAwesome icon) */}
        <button className="chat-header__hamburger">
          <span className="chat-header__hamburger-bar"></span>
          <span className="chat-header__hamburger-bar"></span>
          <span className="chat-header__hamburger-bar"></span>
        </button>
      </div>
      ...
      <div className="chat-header__titles">
        ...
        <h2 className="chat-header__greeting">Coucou, {userName}.</h2>
        <h3 className="chat-header__subtitle">Je suis content de te voir :)</h3>
      </div>
    </div>
  );
};
